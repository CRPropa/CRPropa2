...
typedef enum
    {PHOTON = 0, ELECTRON = 1, POSITRON = 2, PROTON = 3, NEUTRON = 4,
     ELECTRON_NEUTRINO = 5, ANTI_ELECTRON_NEUTRINO = 6, MUON_NEUTRINO = 7,
     ANTI_MUON_NEUTRINO = 8, TAU_NEUTRINO = 9, ANTI_TAU_NEUTRINO = 10,
     NOTHING = 11} 
PARTICLE;
