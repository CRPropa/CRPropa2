...
/*
extern "C" {
  void sophiaevent_(int&, double&, double[][2000], int[], int&, double&, int&, double&) ;
}
*/
extern "C" {
  void sophiaevent_(int&, double&, double[][2000], int[], int&, double&, int&, double&, int&, double[], double[]) ;
}
...
#define _sophiaevent_ sophiaevent_
#endif
